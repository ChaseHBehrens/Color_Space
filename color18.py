...
for i in range(round(n)):
    ...
    for point in points:
        colors.append([100 * (((i/n) + (1/(2*n))) ** scaling), point[0], (((i+1)%2)*i*30) + offset + math.degrees(point[1])])
...
pygame.display.set_caption('Color18')
pixel_size = 1
...
class Camera:
    ...
    def calcuate_point(self, point):
        ...
        rotated_point = [2.5 * rotated_point[1] * math.cos(math.radians(rotated_point[2])), 
                         15 * (13.5 - (rotated_point[0] ** (1 / scaling))), 
